    ...
    while (true)
        {
            ...
            if (endOfDocument)
                {
                    QMessageBox::warning(this, "Find text - QGit", "Text \"" + textToFind + "\" not found!", QMessageBox::Ok, 0);
                    return;
                }
...
void MainImpl::ActAbout_activated()
{
    ...
    "Copyright (c) 2012 Wouter van Kleunen<br>"
    "Copyright (c) 2014 Slyshyk Oleksiy</p>"
